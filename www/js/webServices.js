var api_server = 'http://192.168.1.103/greenhouse/';
var timeout = 20000;
...
function rest_fetchHumidityOverLimit(date) {
    var _url = api_server + 'humidity/overlimit';
    console.log(_url);
    console.log(date);
    return jQuery.ajax({
        type: "GET",
...
function rest_fetchTemperatureOverLimit(date) {
    var _url = api_server + 'temperature/overlimit';
    return jQuery.ajax({
        type: "GET",
        url: _url,
        data: {date: date},
